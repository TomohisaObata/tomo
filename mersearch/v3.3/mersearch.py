    ...
    for i in range(100):
        try:
            ...
            if shop_flg == 'Y':
                ...
                picts =soup.select("#main > article mer-item-thumbnail")
            ...
            if shop_flg == 'Y':
                #出品者
                elements = soup.select('a[class="chakra-link css-19p30tk"] > p[class="chakra-text css-naeo47"]')
                ...
                #カウント
                elements = soup.select('div[class="css-17rqx3h"]  p[class="chakra-text css-95dobi"]')   
            ...
            #価格
            if shop_flg == 'Y':
                elements = soup.select('p[class="chakra-text css-1h7gi4z"]')
                item_price = '\\' + elements[0].contents[0]
            else:
            ...
            if ds['isExProf'] == 'Y' and len(ds['exclutionList']) > 0:
                ...
                if shop_flg == 'Y':
                    ...
                    profile = soup.select('#item-info > section:nth-child(5) a')
                    w_url = profile[0].get('href')
                        ...
                        if len(profile) > 0:
                            try:
                                if shop_flg == 'Y':
                                    ...
                                    profile = soup.select('#main mer-show-more > mer-text')
                                profile_dtl = profile[0].contents[0]
                            except:
                                profile_dtl = ''
                                
                            #print('profile_dtl=',profile_dtl)
